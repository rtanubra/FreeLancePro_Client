...
class DeleteWarning extends Component{
    ...
    render(){
        return (<div className="css_special_delete">
            ...
            <button onClick={()=>{this.context.deleteClient(this.props.clientId)}} className="css_delete_button css_proceed">Proceed</button><button onClick={this.props.handleClientDelete} className ="css_delete_button css_back" >Nevermind</button>      
        </div>)
    }
}
